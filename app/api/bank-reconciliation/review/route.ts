...
import { reviewBankMovement } from "@/lib/bank-reconciliation/reconciliation-service"
...
export async function POST(request: Request) {
  try {
    ...
    const movement = await reviewBankMovement(companyId, body.movementId, session.user.id)
